          ...
          <>
            ...
            {hasAccess('project', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
              <>
                ...
                <NextLink passHref href={`/projects/create?business_organization_id=${data?.id}`}>
                    ...
                    <Tbody>
                      {data?.project?.map((record) => (
                        <Tr key={record.id}>
                          <Td>{record.name}</Td>
                          <Td>
                            <NextLink passHref href={`/projects/edit/${record.id}`}>
                              <Button as="a">Edit</Button>
                            </NextLink>
                          </Td>
                          <Td>
                            <NextLink passHref href={`/projects/view/${record.id}`}>
